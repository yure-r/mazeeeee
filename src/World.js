...
console.warn("sandbox.config.json.infiniteLoopProtection = false");
...
export default class WorldTemplate {
  constructor(container) {
    ...
    this._guiLightOptions = JSON.parse(
      JSON.stringify(this._clientMaze._lightOptions)
    );
    ...
    this._clientMaze.generateSpotLights(
      this._renderer,
      Object.assign(
        this._guiLightOptions,
        this._clientMaze.getCornerSpotLightData()
      )
    );
  ...
  _generateGUI() {
    const guiButtonDir = {
      ...
      solveMaze: () => {
        ...
        this._decideShowSolveBoxesVis();
        let start = [
          this._guiSolve.startZ,
          this._guiSolve.startY,
          this._guiSolve.startX
        ];
        let end = [
          this._guiSolve.endZ,
          this._guiSolve.endY,
      ...
      addVoidSpace: () => {
        try {
          ...
          console.error(
            "guiButtonDir.addVoidSpace error: The voidSpace input on the dat.gui is incorrectly formatted and cannot be parsed properly."
          );
          this._guiMazeConstraintsVoid.voidSpace = "[]";
    ...
    chanceOptions.open();
    chanceOptions
      .add(this._clientMaze.constraints, "xChance", 0, 50, 1)
      .listen()
      .onChange(() => {
    ...
    chanceOptions
      .add(this._clientMaze.constraints, "yChance", 0, 50, 1)
      .listen()
      .onChange(() => {
    ...
    chanceOptions
      .add(this._clientMaze.constraints, "zChance", 0, 50, 1)
      .listen()
      .onChange(() => {
    ...
    chanceOptions
      .add(this._clientMaze.constraints, "diagChance", 0, 50, 1)
      .listen()
      .onChange(() => {
    ...
    chanceOptions
      ...
      .name("DB Vol Lim");
    chanceOptions
      .add(guiButtonDir, "generateBarriers")
      .name("Generate Barriers");
    ...
    mazeSolve
      .add(
        ...
        "startX",
        0,
        this._clientMaze.constraints.width - 1,
        1
      )
      .listen()
      .onChange(() => {
    ...
    mazeSolve
      .add(
        ...
        "startY",
        0,
        this._clientMaze.constraints.height - 1,
        1
      )
      .listen()
      .onChange(() => {
    ...
    mazeSolve
      .add(
        ...
        "startZ",
        0,
        this._clientMaze.constraints.depth - 1,
        1
      )
      .listen()
      .onChange(() => {
    ...
    helperSettings
      ...
      .listen()
      .onChange(() => {
        this._clientMaze.modelAPI(
          "updateLightIntensity",
          this._guiLightOptions.intensity
        );
      })
      .name("Spot Intensity");
    helperSettings
    ...
    const guiAnimateSettingsEXIVector = `[${-this._maxX}, ${-this
      ._maxY}, ${-this._maxZ}]`;
    ...
    animateSettingsFolder
      ...
      .onChange(() => {
        try {
          _animationOptions.groupOrder = JSON.parse(
            this._guiAnimateSettings.groupOrder
          );
        } catch (e) {}
      });
    animateSettingsFolder
    ...
    const barrierSettingsFolder = animateSettingsFolder.addFolder(
      "/ Barrier Group"
    );
    const spaceSettingsFolder = animateSettingsFolder.addFolder(
      "/ Space Group"
    );
    ...
    barrierSettingsFolder
      .add(barrier, "animationSliceOffset", 0, 5, 0.1)
      .name("Slice Offset");
    barrierSettingsFolder
      .add(barrier, "animationSliceDuration", 0, 5, 0.1)
      .name("Slice Duration");
    barrierSettingsFolder
      .add(barrier.entrance, "type", {
        visible: "visible",
        slide: "slide"
      })
      .setValue(barrier.entrance.type)
      .name("entrance Type")
      .listen()
      .onChange((e) => {
        barrier.entrance.type = e;
      });
    barrierSettingsFolder
      ...
      .onChange((v) => {
        v = JSON.parse(v);
        barrier.entrance.distance.x = v[0];
        barrier.entrance.distance.y = v[0];
        barrier.entrance.distance.z = v[0];
      })
      .name("Ent Slide XYZ");
    barrierSettingsFolder
    ...
    barrierSettingsFolder
      .add(barrier.exit, "exitDelay", 0, 5, 0.1)
      .name("Exit Delay");
    ...
    spaceSettingsFolder
      .add(space, "animationSliceOffset", 0, 5, 0.1)
      .name("Slice Offset");
    spaceSettingsFolder
      .add(space, "animationSliceDuration", 0, 5, 0.1)
      .name("Slice Duration");
    spaceSettingsFolder
      .add(space.entrance, "type", {
        visible: "visible",
        slide: "slide"
      })
      .setValue(space.entrance.type)
      .name("entrance Type")
      .listen()
      .onChange((e) => {
        space.entrance.type = e;
      });
    spaceSettingsFolder
      ...
      .onChange((v) => {
        v = JSON.parse(v);
        space.entrance.distance.x = v[0];
        space.entrance.distance.y = v[0];
        space.entrance.distance.z = v[0];
      })
      .name("Ent Slide XYZ");
    spaceSettingsFolder
    ...
    spaceSettingsFolder
      .add(space.exit, "exitDelay", 0, 5, 0.1)
      .name("Exit Delay");
    ...
    voidSettingsFolder
      .add(voidRef, "animationSliceOffset", 0, 5, 0.1)
      .name("Slice Offset");
    voidSettingsFolder
      .add(voidRef, "animationSliceDuration", 0, 5, 0.1)
      .name("Slice Duration");
    voidSettingsFolder
      .add(voidRef.entrance, "type", {
        visible: "visible",
        slide: "slide"
      })
      .setValue(voidRef.entrance.type)
      .name("entrance Type")
      .listen()
      .onChange((e) => {
        voidRef.entrance.type = e;
      });
    voidSettingsFolder
      ...
      .onChange((v) => {
        v = JSON.parse(v);
        voidRef.entrance.distance.x = v[0];
        voidRef.entrance.distance.y = v[0];
        voidRef.entrance.distance.z = v[0];
      })
      .name("Ent Slide XYZ");
    voidSettingsFolder
    ...
    voidSettingsFolder
      .add(voidRef.exit, "exitDelay", 0, 5, 0.1)
      .name("Exit Delay");
    ...
    mapSettingsFolder
      .add(map, "animationSliceOffset", 0, 5, 0.1)
      .name("Slice Offset");
    mapSettingsFolder
      .add(map, "animationSliceDuration", 0, 5, 0.1)
      .name("Slice Duration");
    mapSettingsFolder
      .add(map.entrance, "type", {
        visible: "visible",
        slide: "slide"
      })
      .setValue(map.entrance.type)
      .name("entrance Type")
      .listen()
      .onChange((e) => {
        map.entrance.type = e;
    ...
    mapSettingsFolder
      ...
      .onChange((v) => {
        v = JSON.parse(v);
        map.entrance.distance.x = v[0];
        map.entrance.distance.y = v[0];
        map.entrance.distance.z = v[0];
      })
      .name("Ent Slide XYZ");
    mapSettingsFolder
    ...
    pathSettingsFolder
      .add(path, "animationSliceOffset", 0, 5, 0.1)
      .name("Slice Offset");
    pathSettingsFolder
      .add(path, "animationSliceDuration", 0, 5, 0.1)
      .name("Slice Duration");
    pathSettingsFolder
      .add(path.entrance, "type", {
        visible: "visible",
        slide: "slide"
      })
      .setValue(path.entrance.type)
      .name("entrance Type")
      .listen()
      .onChange((e) => {
        path.entrance.type = e;
      });
    pathSettingsFolder
      ...
      .onChange((v) => {
        v = JSON.parse(v);
        path.entrance.distance.x = v[0];
        path.entrance.distance.y = v[0];
        path.entrance.distance.z = v[0];
      })
      .name("Ent Slide XYZ");
    pathSettingsFolder
